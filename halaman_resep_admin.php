...
<head>
    ...
    <body>
        <div class="container">
            <a href="halaman_utama_admin.php" class="back">Back</a>

            <h1><?= $baris['namaResep']; ?></h1>
            <form action="php/favorite_toggle_admin.php?halFav=no" method="post" style="display:inline;">
        ...
        <h2>Komentar</h2>
        <form id="commentForm" action="php/komentar_admin.php?fav=no" method="post">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['username'] === $username) {
                        echo "<form action='php/hapus_komentar_admin.php?fav=no' method='post' style='margin-top:5px;'>";
