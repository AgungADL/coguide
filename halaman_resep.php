...
<head>
    ...
    <body>
        <div class="container">
            ...
            <form action="php/favorite_toggle.php?halFav=no" method="post" style="display:inline;">
        ...
        <h2>Komentar</h2>
        <form id="commentForm" action="php/komentar.php?fav=no" method="post">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['username'] === $username) {
                        echo "<form action='php/hapus_komentar.php?fav=no' method='post' style='margin-top:5px;'>";
